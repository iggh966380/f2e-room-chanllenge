...
import { MouseEnterEvent, MouseLeaveEvent, MouseClickEvent, } from "./mouse-event.js";
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    imgArea = document.querySelector("#photo");
                    return [4 /*yield*/, fetchRooms()];
                case 1:
                    rooms = _a.sent();
                    rooms.forEach(function (item, index) {
                        var link = document.createElement("a");
                        var linkClasses = ["showcase-img", "bg-center"];
                        new AddClass(link, linkClasses).addClass();
                        var text = document.createElement("span");
                        var textClasses = ["d-none"];
                        new AddClass(text, textClasses).addClass();
                        link.href = "./booking.html";
                        link.style.backgroundImage = "url(".concat(rooms[index].imageUrl, ")");
                        text.textContent = "".concat(rooms[index].name);
                        imgArea.append(link);
                        link.append(text);
                        var mouseEvent = [
